...
--
-- Name: elements employee_unq; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT employee_unq UNIQUE (symbol);


--
-- Name: elements employee_unq_2; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT employee_unq_2 UNIQUE (name);
...
--
-- Name: properties fk_properties_an; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fk_properties_an FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
